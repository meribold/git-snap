...
| exists       | exists |        | exists                  | untracked file, staged                  | :wavy_dash:        | updated to working tree version |
...
| exists       |        | exists |                         | ''                                      |                    |                                 |
| exists       |        |        | exists                  | untracked file, not staged              | :heavy_minus_sign: | removed from snapshots branch   |
| exists       |        |        |                         | ''                                      |                    |                                 |
